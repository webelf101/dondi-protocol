...
mypath = "/home/udeve/workspace/kassia-home/build/contracts"
onlyfiles = [f for f in listdir(mypath) if isfile(join(mypath, f))]
onlyfiles

for file in onlyfiles:
    with open("/home/udeve/workspace/kassia-home/build/contracts/"+file, "r") as f:
        if "json" in file:
            try:
                cleaned = {}
                a = json.loads(f.read())
                ...
                with open("/home/udeve/workspace/kassia-home/clean_build/contracts/"+file, "w+") as c:
