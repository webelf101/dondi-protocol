...
async function deployDistribution(deployer, network, accounts) {
  ...
  if (network != "test") {
    await deployer.deploy(TIMETRAVEL_ETHPool);
    await deployer.deploy(TIMETRAVEL_uAMPLPool);
    await deployer.deploy(TIMETRAVEL_YFIPool);
    await deployer.deploy(TIMETRAVELIncentivizer);
    await deployer.deploy(TIMETRAVEL_LINKPool);
    await deployer.deploy(TIMETRAVEL_MKRPool);
    await deployer.deploy(TIMETRAVEL_LENDPool);
    await deployer.deploy(TIMETRAVEL_COMPPool);
    await deployer.deploy(TIMETRAVEL_SNXPool);
