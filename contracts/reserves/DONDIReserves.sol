...
contract DONDIReserves {

    // Token that serves as a reserve for DONDI
        ...
        onlyGov
    {
        ...
        DONDITokenInterface(dondiAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        DONDITokenInterface(dondiAddress).approve(rebaser_, uint256(-1));
